...
use crate::abi::v0_2_1::{ContextId, Guest, StreamState};
...
/// [`GuestError::Runtime`](crate::abi::v0_2_1::GuestError::Runtime) for a
/// failure of the
/// runtime.
...
mod tests {
    ...
    use crate::abi::v0_2_1::{
        Access, Callback, ContextProblem, ContextState, GuestError, Invocation, NoStream,
        PluginConfig,
    };
